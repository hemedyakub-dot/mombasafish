...
var REVIEWS = [
  ...
  /* Delete this whole block and paste your own, like this:

  { q:"Nimeagiza mara tatu sasa. Samaki ni fresh kabisa, na wanafika Nairobi bado baridi.",
    who:"Amina H.", where:"Nairobi", what:"Changu, 4 kg" },

  { q:"I was worried about ordering fish online but the box arrived still cold and the prawns were exactly the size shown.",
    who:"Peter M.", where:"Nakuru", what:"Tiger prawns, 2 kg" },
