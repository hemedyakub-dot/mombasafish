...
(function () {
  ...
  var KB = [
    ...
    { k: ['box', 'boxes', 'bundle', 'combo', 'familia', 'bwanaharusi', 'boil', 'choma box'], a: 'Five ready-made boxes, each cheaper than buying the same seafood apart.\n\nOmega-3 Combo, 1,500. Familia, 2,900. Choma, 3,600. Seafood Boil, 5,700. And the Bwanaharusi Special at 9,500 — six kilos for a day that matters.', sw: 'Visanduku vitano vilivyotayarishwa, kila kimoja ni rahisi kuliko kununua vitu vilevile mmoja mmoja.\n\nOmega-3 Combo, 1,500. Familia, 2,900. Choma, 3,600. Seafood Boil, 5,700. Na Bwanaharusi Special.', f: [] },
  ...
  var ALT = {
    nguru:['jodari','kolekole','sulisuli-kipanga'], jodari:['nguru','sulisuli','sulisuli-kipanga'],
    ...
    pono:['tewa','tafi','changu'], tafi:['pono','tewa','changu'],
    kolekole:['changu','nguru','red-snapper'], 'red-snapper':['changu','tewa','kolekole'],
    mkundaji:['changu','tafi','pono'], songoro:['changu','kolekole','tewa'],
    papa:['red-snapper-fillets','tilapia-fillets','pono'],
    simusimu:['una','uwono'], una:['simusimu','uwono'], uwono:['simusimu','una'],
  ...
  var FIRM = ['nguru','jodari','sulisuli','sulisuli-kipanga','kolekole','papa'];
  ...
  function reply(q, m) {
    if (!m) {
      say('That one I cannot tell you.\n\nIt is outside what I know. The people at the shop will answer you properly — they are quick.',
        'b', '<a class="bs-wa" href="' + waLink(q) + '">' + T('Ask the team on WhatsApp →', 'Uliza wafanyakazi kwenye WhatsApp →') + '</a>');
      return;
    }
    var extra = '';
    if (m.cart) {
