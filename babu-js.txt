...
(function () {
  ...
  var KB = [
    ...
    { k: ['deliver', 'delivery', 'transport', 'shipping', 'send', 'county', 'nairobi', 'nakuru', 'kisumu', 'eldoret', 'kuleta', 'usafiri', 'kufikisha'], a: 'Anywhere in Kenya. Mombasa the same day by rider. Everywhere else by express courier or bus, in a sealed cooler with ice that holds cold for up to seventy-two hours.\n\nThe box price you can see on the shop page. The transport we quote you before you pay a shilling — we pass on what the transporter charges us and add nothing.', f: [] },
  ...
  var HANDOFF = ['uganda', 'tanzania', 'rwanda', 'somalia', 'ethiopia', 'export to', 'ship abroad',
    'pay after', 'pay later', 'credit', 'invoice', 'discount', 'cheaper price', 'negotiate',
  ...
  var TALK = [
    { id:'shikamoo', k:['shikamoo','shikamo'], reply: function(){
    ...
    { id:'greet', k:['hello','hallo','hi','hey','habari','jambo','mambo','sasa','salaam','salam',
        'good morning','good afternoon','good evening','niaje','vipi','hujambo','karibu'], reply: function(){
        return timeGreet() + '\n\n' + pick([
    ...
    { id:'howareyou', k:['how are you','habari yako','u hali gani','how you doing','uko aje'], reply: function(){
        return pick([
    ...
    { id:'thanks', k:['thank','thanks','asante','shukran','shukrani','nashukuru','appreciate'], reply: function(){
        return pick([
          'Karibu sana.',
          'Karibu. It is nothing.',
          'Karibu, mwanangu.' ]) + '\n\nCome back when you need me. I do not go anywhere.'; } },
    ...
    { id:'bye', k:['bye','goodbye','kwaheri','later','see you','tutaonana','baadaye','good night','usiku mwema'],
      reply: function(){
        return pick([
          ...
          'Kwaheri, mwanangu. The sea will still be here tomorrow.' ]); } },

    { id:'who', k:['who are you','what is your name','your name','who is babu','are you babu',
        'wewe ni nani','jina lako'], reply: function(){
    ...
    { id:'real', k:['are you real','are you human','are you a robot','are you a bot','are you ai',
        'are you a person','ni mtu','wewe ni roboti','are you alive','chatbot'], reply: function(){
    ...
    { id:'canyou', k:['what can you do','can you help','how do you work','what do you know',
        'unaweza nini','unajua nini','help me'], reply: function(){
    ...
    { id:'compliment', k:['i love','nice site','beautiful site','good site','well done','you are helpful',
        'good job','impressive','poa','nzuri sana','safi','vizuri'], reply: function(){
        return pick([
    ...
    { id:'complaint', k:['not happy','unhappy','disappointed','bad service','you are late','late delivery',
        ...
        'nimechelewa','never arrived','did not arrive','wrong order'], reply: function(){
    ...
    { id:'order', k:['where is my order','my order','track my order','order status','my delivery',
        'oda yangu','imefika wapi','when will it arrive','has it been sent','dispatched'], reply: function(){
    ...
    { id:'company', k:['who owns','who runs','about the company','about mombasafish','your company',
        'tell me about you','your story','how long have you','who started'], reply: function(){
    ...
    { id:'shimoni', k:['why shimoni','where is shimoni','about shimoni','pemba channel'], reply: function(){
    ...
    { id:'ack', k:['ok','okay','sawa','sawa sawa','alright','fine','yes','yeah','ndiyo','no','hapana',
        'haha','hahaha','lol','hmm','cool','great','sure'], whole: true, reply: function(){
  ...
  function answer(q) {
    ...
    if (tm && (!greeted || !stripped)) {
      setTimeout(function () {
        var extra = '';
        if (tm.wa)    extra = '<a class="bs-wa" href="' + waLink(q) + '">Talk to the team on WhatsApp →</a>';
        if (tm.track) extra = '<a class="bs-wa" style="background:#07474C" href="' + BASE + 'track.html">Track my order →</a>';
        if (tm.link)  extra = '<a class="bs-wa" style="background:#07474C" href="' + BASE + tm.link + '">' + tm.linkLabel + '</a>';
        say(tm.reply(), 'b', extra);
      }, 240);
      return;
    }
