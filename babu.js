...
(function () {
  ...
  var KB = [
    ...
    { k: ['i want to buy', 'want to buy', 'buy now', 'how do i buy', 'how do i order', 'where is the catalogue', 'where is the catalog', 'wheres the shop', 'show me the shop', 'see the list', 'see prices', 'price list', 'orodha', 'nataka kununua', 'ninataka kununua', 'nunua', 'ninanunuaje', 'naagizaje', 'nataka kuagiza', 'bei zenu', 'wapi nanunua'], a: 'Good. Come this way.\n\nEverything is on the catalogue page \u2014 every fish, every price per kilo, and the ready-made boxes below them. Tap what you want, choose your kilos, and it goes into the basket.\n\nWhen you are finished, the basket takes your name and where you are, and the order comes straight to the shop. No forms, no account, no waiting.\n\nIf you would rather just tell somebody what you want, the WhatsApp button does that too.', sw: 'Vizuri. Njoo huku.\n\nKila kitu kiko kwenye ukurasa wa katalogi \u2014 kila samaki, kila bei kwa kilo, na visanduku vilivyo tayari chini yake. Gusa unachotaka, chagua kilo zako, na kitaingia kwenye kikapu.\n\nUkimaliza, kikapu kitachukua jina lako na ulipo, na oda itaenda moja kwa moja dukani. Hakuna fomu, hakuna akaunti, hakuna kusubiri.\n\nUkipendelea kumwambia mtu tu unachotaka, kitufe cha WhatsApp kinafanya hivyo pia.', f: [], doc: { href: 'catalogue.html', title: 'Open the catalogue \u2014 all fish and prices' } },
    { k: ['libido', 'sex boost', 'sex drive', 'aphrodisiac', 'stamina', 'virility', 'potency', 'fish for men', 'good for men', 'nguvu za kiume', 'nguvu', 'hamu', 'mvuto', 'bedroom', 'performance', 'fertility', 'sperm', 'testosterone'], a: 'You are not the first to ask me, and you will not be the last.\n\nOysters are what the old people point to, and there is something real behind it: oysters carry more zinc than almost any food on earth, and zinc is what the body uses to make the hormones men ask me about. Forty shillings each. Crab, prawns and lobster carry it too.\n\nThe oily fish \u2014 simusimu, una, jodari \u2014 do a quieter job. Omega-3 is good for the blood and the heart, and what is good for the heart is good for the rest of a man.\n\nBut let me be straight with you, as an old man to a younger one. Food is food, not medicine. It will not undo bad sleep, too much beer, or a body that is telling you something. If there is a real problem there, see a doctor and do not be shy about it. Then come and eat well anyway.', sw: 'Wewe si wa kwanza kuniuliza, wala hutakuwa wa mwisho.\n\nChaza ndio wanaotajwa na wazee, na kuna ukweli ndani yake: chaza wana zinki nyingi kuliko karibu chakula chochote duniani, nayo zinki ndiyo mwili hutumia kutengeneza homoni. Shilingi arobaini kila mmoja. Kaa, kamba na kamba wa miamba nao wanayo.\n\nSamaki wenye mafuta \u2014 simusimu, una, jodari \u2014 hufanya kazi ya kimyakimya. Omega-3 ni nzuri kwa damu na moyo, na kilicho kizuri kwa moyo ni kizuri kwa mwili wote.\n\nLakini nikuambie ukweli, mzee kwa kijana. Chakula ni chakula, si dawa. Hakitarekebisha usingizi mbaya, pombe nyingi, au mwili unaokuambia jambo. Kama kuna tatizo la kweli, muone daktari wala usione haya. Kisha uje ule vizuri.', f: ['oysters', 'prawns-tiger', 'simusimu'] },
    { k: ['hello vipi', 'vipi', 'mambo', 'sasa', 'niaje', 'uko', 'upo', 'hujambo', 'shikamoo', 'salama', 'kwaheri', 'good morning', 'good evening', 'good afternoon', 'hey there', 'anyone there', 'are you there', 'uko hapo'], a: 'Nipo hapa. I am here.\n\nAsk me about any fish on this page \u2014 what it tastes like, what it costs, how to cook it, which one suits your table. Forty years I have been doing this. Try me.', sw: 'Nipo hapa.\n\nNiulize kuhusu samaki yeyote kwenye ukurasa huu \u2014 ladha yake, bei yake, jinsi ya kumpika, yupi anafaa meza yako. Miaka arobaini nimefanya kazi hii. Nijaribu.', f: [], whole: true },
    { k: ['how many oceans', 'deepest part', 'deepest place', 'how deep', 'mariana', 'indian ocean', 'bahari ya hindi', 'kina cha bahari', 'bahari ngapi', 'how big is the ocean', 'ocean facts', 'tides', 'maji kujaa', 'currents', 'why is the sea salty', 'chumvi ya bahari'], a: 'Ah, you want to talk about the sea itself. Sit.\n\nFive oceans, the books say \u2014 Pacific, Atlantic, Indian, Southern, Arctic. Ours is the Indian, and it is the warmest of them. The deepest place anywhere is the Mariana Trench in the Pacific, near eleven kilometres down. Deeper than the highest mountain is tall.\n\nOff Shimoni our water drops fast into the Pemba Channel, and that is why the big fish pass here.\n\nThere is a whole page on this coast now if you want more than an old man\u2019s talk.', sw: 'Aha, unataka kuzungumza kuhusu bahari yenyewe. Kaa.\n\nBahari tano, vitabu vinasema \u2014 Pasifiki, Atlantiki, Hindi, Kusini, na Aktiki. Yetu ni ya Hindi, nayo ni yenye joto zaidi. Mahali penye kina kirefu kuliko pote ni Mariana Trench huko Pasifiki, karibu kilomita kumi na moja chini.\n\nMbele ya Shimoni maji yetu hushuka haraka kuingia Pemba Channel, ndiyo maana samaki wakubwa hupita hapa.\n\nKuna ukurasa mzima kuhusu pwani hii sasa ukitaka zaidi.', f: [], doc: { href: 'coast.html', title: 'MombasaFish Ocean \u2014 the coast' } },
    { k: ['asthma', 'asthmatic', 'pumu', 'diabetes', 'kisukari', 'blood pressure', 'shinikizo', 'cholesterol', 'heart', 'moyo', 'arthritis', 'joints', 'inflammation', 'good for my health'], a: 'The oily fish are what you want \u2014 simusimu, una, uwono, jodari. They carry the omega-3, and omega-3 is the part doctors talk about for the heart, the blood and swelling in the body. Two meals a week is the usual advice, and they are the cheapest fish I sell.\n\nHow you cook them matters as much as which you buy. Grill or steam. Deep frying in old oil undoes the good you came for. Go easy on the salt if it is your blood pressure.\n\nBut hear me clearly: I sell fish, I do not treat people. Whatever your doctor told you comes first, and if you are on medicine, ask them before you change how you eat.', sw: 'Samaki wenye mafuta ndio unaowataka \u2014 simusimu, una, uwono, jodari. Wana omega-3, nayo ndiyo madaktari huzungumzia kwa moyo, damu na uvimbe mwilini. Milo miwili kwa wiki, nao ndio rahisi zaidi ninaowauza.\n\nJinsi unavyowapika ni muhimu kama unavyowanunua. Choma au chemsha. Kukaanga kwenye mafuta ya zamani kunaharibu uzuri uliokuja kuutafuta. Punguza chumvi kama ni shinikizo la damu.\n\nLakini nisikilize vizuri: mimi nauza samaki, sitibu watu. Alichokwambia daktari wako kinatangulia.', f: ['simusimu', 'jodari', 'una'] },
  ...
  function match(qRaw) {
    ...
    /* a bare one- or two-word question is a strong signal even when the word
       is short: 'una', 'tewa', 'pono' are whole questions on their own */
    var terse = q.trim().split(' ').length <= 2;
    if (bestScore >= 4 || (terse && bestScore >= 3)) return best;
    var freq = {};
    CAT.forEach(function (p) {
      var seen = {};
      norm(p.title).split(' ').forEach(function (w) {
        if (w.length > 3 && !seen[w]) { seen[w] = 1; freq[w] = (freq[w] || 0) + 1; }
      });
    });
    var hit = CAT.filter(function (p) {
      var t = norm(p.title + ' ' + (p.sub || ''));
      return t.split(' ').some(function (w) {
        /* a word in four or more titles ("fish", "prawns", "fillets") names no
           single product, so it must not answer on its own */
        /* a word absent from every title (the Swahili name in `sub`) is as
           distinctive as it gets, so treat a missing count as 1, not 0 */
        if (w.length < 3 || q.indexOf(' ' + w + ' ') === -1) return false;
        /* a word in four or more titles ("fish", "prawns", "fillets") names no
           single product. A word in no title at all is the Swahili name from
           `sub` -- as distinctive as it gets, so a missing count means 1. */
        if ((freq[w] || 1) >= 4) return false;
        /* three-letter names (una, kaa) are also ordinary Swahili words --
           "una samaki gani" means "what fish do you have". Only let those
           speak when the whole question is that word. */
        if (w.length === 3) return terse && !freq[w];
        return true;
      });
    });
    if (hit.length) {
  ...
  var NOT_WASTE = /\b(no|few|fewest|without|any|less|least)\s+(bones|bone)\b|hana (miiba|mifupa)|bila (miiba|mifupa)|hakuna miiba|\b(dog|dogs|puppy|cat|cats|kitten|pet|mbwa|paka)\b/i;
  ...
  function outcomeOf(extra, text) {
    var e = extra || '';
    /* distinguish the three very different things that all carry a wa.me link:
       a real give-up, an answer from the model, and a good rulebook answer that
       simply offers the team as well */
    if (/wa\.me/.test(e)) {
      if (/Send my question|Peleka swali/.test(e)) return 'giveup';
      if (/Check with the team|Thibitisha na/.test(e)) return 'model';
      return 'handoff';
    }
  ...
  var ASK_URL = 'https://tcpqbrchpxpshmqprbkv.supabase.co/functions/v1/babu-ask';
  var ASK_TRIES = 0;
  ...
  function thinking(on) {
    ...
    d.id = 'bsThink';
    d.textContent = T('Let me think about that\u2026', 'Hebu nifikirie hilo\u2026');
    log.appendChild(d);
    log.scrollTop = log.scrollHeight;
  }
  ...
  function answer(q) {
    ...
    /* a question about feeding an animal is not a fish question at all */
    if (/\b(dog|dogs|puppy|cat|cats|kitten|pet|mbwa|paka)\b/i.test(q)) {
      setTimeout(function () { reply(q, matchSection(q)); }, 120); return;
    }
